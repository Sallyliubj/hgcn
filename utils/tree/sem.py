import numpy as np
from utils.tree.tree_utils import create_tree, draw_dendrogram
from utils.tree.substitution_models import JukesCantor
from utils.tree.data_utils import get_char_data, simulate_seq
import utils.tree.computations as cmp
from utils.tree.mst_utils import get_mst, bifurcate_mst
...
def main(n_leaves=50, ndata=100, load_data=False):
    ...
    data = simulate_seq(tree, jc, ndata)
